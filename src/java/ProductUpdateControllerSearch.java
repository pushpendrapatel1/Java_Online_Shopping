 ...
 */
@MultipartConfig
public class ProductUpdateControllerSearch extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ProductUpdateControllerSearch</title>");            
            out.println("</head>");
            out.println("<body>");
...
//            rd.forward(request, response);
           FileOutputStream fos = new FileOutputStream(upload);
            ...
            out.println("<h1>Servlet ProductUpdateControllerSearch at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
