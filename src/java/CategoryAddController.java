...
public class CategoryAddController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            cb.setCategorydetails(cdetails);
            
           
            CategoryDao cd=new CategoryDao();
             int x=cd.addCategory(cb);
              String message = (x > 0) ? "Category Added Successfully" : "Category Added Failed";
            request.setAttribute("message", message);
            RequestDispatcher rd = request.getRequestDispatcher("Osucategorytable.jsp");
...
//                 RequestDispatcher rd=request.getRequestDispatcher("CategoryAdd.jsp");
//                 rd.forward(request, response);
//                 out.println("Category Added Sucessfully");
//             }
//             else{
//                
//                 RequestDispatcher rd=request.getRequestDispatcher("CategoryAdd.jsp");
//                 rd.forward(request, response);
//                  out.println("Category Added failed");
//             }
            out.println("</body>");
            out.println("</html>");
        }
