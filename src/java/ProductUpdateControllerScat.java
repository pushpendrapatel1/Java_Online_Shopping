...
@MultipartConfig
public class ProductUpdateControllerScat extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ProductUpdateControllerScat</title>");            
            out.println("</head>");
            out.println("<body>");
...
//           
           ...
           FileOutputStream fos = new FileOutputStream(upload);
            ...
            out.println("<h1>Servlet ProductUpdateControllerScat at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
