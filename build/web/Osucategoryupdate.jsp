<%-- 
    Document   : Osucategoryupdate
    Created on : Apr 14, 2023, 8:24:59 PM
...
<body>
    ...
    <div class="container4">
        <div class="navbar">
            ...
            <nav>
                <h4>Welcome pushpendra  Patel</h4>
                <ul id="MenuItems">
                    ...
                    <div class="form_container1">
                        ...
                        %>
                            <table class="addproducttable">
                                <tr>
                                <td><input type="hidden" name="cid"  value="<%=cb.getCategoryid() %>  "></td>
                            <tr>
                                <tr>
                                    <td>Category Name</td>
                                    <td><input type="text" name="cname" required  value="<%=cb.getCategoryname()%>  " ></td>
                                </tr>
                               
                                <tr>
                                    <td>Category Details</td>
                                    <td><input type="text"  name="cdetails" required value="<%=cb.getCategorydetails()%>  "   ></td>
                                </tr>
