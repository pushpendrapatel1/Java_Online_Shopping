<%-- 
    Document   : Customerheaderhome
    Created on : Apr 15, 2023, 12:45:28 PM
...
<html>
    ...
    <body>
        ...
        <div class="header" style="background: radial-gradient(#fff, rgb(178, 220, 233));">
...
//                           
                            ...
                            CustomersDao cda = new CustomersDao();
                            CustomersBean cba = cda.findbyCustomerid(customerid);
                        %>

                        <h4 id="customername">Welcome &nbsp; <%= cba.getCustomername()%> </h4>
                ...
                <div class="row">
                    <div class="col_2">
                        ...
                        <p>Sucess isn't always about greatness . It's About consistency . <br> consistent hard work gain
                            sucess . Greatness will come .</p>
                        <a href="CustomerProductView.jsp" class="btn">Explore Now &#8594;</a>
                    </div>
                    <div class="col_2">
                        <img src="Images/phoneadd2.png" alt="">
                    </div>
                </div>
            </div>
        </div>
